  ...
  return (
    <footer className="bg-cover bg-center relative">
      ...
      <div className=" bg-white text-black">
        <div className="flex justify-center items-center gap-x-64 p-12">
          <div>
            <Link className="flex items-center pb-1" href="/">
              <Image src={LOGO} alt="logo" width={60} height={60} />
              <h2 className="text-3xl text-primary font-semibold gap-2">
                Quantum
              </h2>
            </Link>
